...
----------------------------------------------------------------------------------------------------
-- the three most modRequireant matrices for 3d graphics
...
-- sets to a perspective projection matrix
...
-- sets to an orthographic projection matrix.
...
setmetatable(matrix, {__call = function(t, ...)
    return newMatrix(...)
end})
