...
function Dummy:init()
    ...
    self.dialogue = {
	"[voice:none][color:white][shake:0.75][spacing:2][speed:0.5][imbuedstatic:true,0.3]Cold...[imbuedstatic:unstatic,0]",
	"[voice:none][color:white][shake:0.75][spacing:2][speed:0.5][imbuedstatic:true,0.3]Delta Warriors, [wait:5]please..![imbuedstatic:unstatic,0]",
	"[voice:none][color:white][shake:0.75][spacing:2][speed:0.5][imbuedstatic:true,0.3]Water you doing just \nstanding there?[imbuedstatic:unstatic,0]"
	}
...
function Dummy:update()
    ...
    if self.nametimer <= 0 then
        self.nametimer = 2
        local chars = { "M", "I", "Z", "L", "E" , "m", "i", "z", "l", "e" }
        local name = {}
        for i = 1,6 do
