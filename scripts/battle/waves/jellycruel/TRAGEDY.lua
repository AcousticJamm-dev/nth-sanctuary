...
function Basic:onStart()
    ...
    self.timer:script(function(wait)
        ...
        self.timer:tween(3, Game.battle.arena, {y = Game.battle.arena.y + 720, rotation = fliprot}, "in-cubic", function()
			FRAMERATE = self.last_framerate
            if Game.battle.soul.y > SCREEN_HEIGHT + 19 then
                ...
                self.timer:after(1, function()
                    ...
                    for _, battler in ipairs(Game.battle.party) do
						local last_hit_count = battler.hit_count
						battler:hurt(40)
						...
						if not battler:hasStatus("poison") then
							...
							Game.battle.timer:after(1/30, function()
								if battler.hit_count == last_hit_count then
