---@class BurstObj : Object
---@overload fun(...) : BurstObj
local BurstObj, super = Class(Object)

function BurstObj:init(x, y, color, sprite)
    super.init(self, x, y)
    ...
    self.heart_outline_outer = Assets.getTexture(sprite)
    self.heart_outline_inner = Assets.getTexture(sprite)
    self.heart_outline_filled_inner = Assets.getTexture(sprite)
end

function BurstObj:update()
    self.burst = self.burst + DTMULT/5
...
function BurstObj:drawHeartOutline(scale_x, scale_y, alpha)
