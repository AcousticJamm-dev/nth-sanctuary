...
function VaporRipple:draw()
	...
	Draw.setColor(self.color, self.alpha * 0.25)
    love.graphics.circle('line', 0, 0, self.size - (self.line_width * 2), self.points)
	Draw.setColor(self.color, self.alpha * 0.65)
    love.graphics.circle('line', 0, 0, self.size - self.line_width, self.points)
