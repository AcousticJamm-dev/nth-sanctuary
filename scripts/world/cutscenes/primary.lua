return {
	...
	firsttravel = function (cutscene)
		...
		cutscene:text("* Well, at least we aren't stuck anymore?", "nervous_side", "susie")
		cutscene:text("* ...[wait:5]", "neutral_side", "susie")
		cutscene:text("* Where are we, anyways?", "neutral", "susie")
		cutscene:text("* I'm not sure, Susie.", "look_left", "ralsei")
		cutscene:text("* There's a bunch of doors here...", "look_left", "ralsei")
		cutscene:text("* Are they... warp doors???", "look_left", "ralsei")
		...
		cutscene:text("* Ralsei!! Hey! It's...[wait:5]", "suspicious", "susie")
		cutscene:text("* I know we'll be able to figure it out, alright?", "suspicious", "susie")
		cutscene:text("* WE were able to beat a TITAN, man.", "suspicious", "susie")
		cutscene:text("* We can stop whatever's going on here too.", "suspicious", "susie")
		cutscene:text("* ...[wait:5]I just know we can do this.", "suspicious", "susie")
		cutscene:text("* ...And Jamm? We'll find Marcy. I promise.", "suspicious", "susie")
		cutscene:text("* ...[wait:5]", "suspicious", "jamm")
		cutscene:text("* We better.", "suspicious", "jamm")
		cutscene:wait(1)
